...
# CONFIG
# --------------------------------------------------
BASE_DIR = "train_data/medicine_B"
MODEL_DIR = "models/medicine_B"
...
print("\n🔍 Training Model-B (Medicine B)\n")

# --------------------------------------------------
# 1️⃣ Extract fingerprints
# --------------------------------------------------
...
geometry_ref = {
    ...
    "area_tolerance": 0.15,      # 35%
    "aspect_tolerance": 0.08     # 15%
}
