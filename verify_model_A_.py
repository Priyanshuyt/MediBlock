"""
Medicine A Verification Logic
-----------------------------
Uses geometry checks + ML decision function
to verify authenticity of Medicine A tablets.
"""
...
MODEL_DIR = os.path.join(BASE_DIR, "models", "medicine_A")
...
def verify_image_A(image_path):
    """Verify a Medicine A tablet image."""
